...
namespace The_Quest
{
    class Game
    {
        public IEnumerable<Enemy> Enemies { get; private set; } //s

        public Weapon WeaponInRoom  { get; private set;  } //s

        private Player player;
   
        public Point PlayerLocation { get { return player.Location; } } //s

        public int PlayerHitPoints { get { return player.HitPoints; } } //s
        ...
        {   
            return new Point(boundaries.Left + random.Next(boundaries.Right / 10 -
                boundaries.Left / 10) * 10, boundaries.Top + 
